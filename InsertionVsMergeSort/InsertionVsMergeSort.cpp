...
int main() {
    ...
    original = make_vector(100'000, 1'000'000);

    insertion_working = original;
    auto start_time = clock();
    insertion_sort(insertion_working);
    auto stop_time = clock();
    auto insertion_time = static_cast<double>(stop_time - start_time) / CLOCKS_PER_SEC;
    ...
    merge_sort(merge_working);
    stop_time = clock();
    auto merge_time = static_cast<double>(stop_time - start_time) / CLOCKS_PER_SEC;
